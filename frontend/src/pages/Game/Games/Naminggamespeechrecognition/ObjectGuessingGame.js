...
const ObjectGuessingGame = () => {
  const [objects] = useState([
    { name: "apple", imageUrl: "https://upload.wikimedia.org/wikipedia/commons/1/15/Red_Apple.jpg" },
    { name: "dog", imageUrl: "https://upload.wikimedia.org/wikipedia/commons/6/6e/Golde33443.jpg" },
    { name: "banana", imageUrl: "https://upload.wikimedia.org/wikipedia/commons/8/8a/Banana-Single.jpg" },
    { name: "flower", imageUrl: "https://upload.wikimedia.org/wikipedia/commons/4/4c/Flower.jpg" },
    { name: "book", imageUrl: "https://upload.wikimedia.org/wikipedia/commons/1/1d/Book.jpg" },
    { name: "cat", imageUrl: "https://upload.wikimedia.org/wikipedia/commons/a/a2/Gray_cat.jpg" },
    { name: "tree", imageUrl: "https://upload.wikimedia.org/wikipedia/commons/4/47/Tree.jpg" },
    { name: "ball", imageUrl: "https://upload.wikimedia.org/wikipedia/commons/2/2d/Football.jpg" },
    { name: "bird", imageUrl: "https://upload.wikimedia.org/wikipedia/commons/7/72/Bird%2C_parakeet.jpg" },
    { name: "hat", imageUrl: "https://upload.wikimedia.org/wikipedia/commons/d/d3/Baseball_cap.jpg" },
    { name: "phone", imageUrl: "https://upload.wikimedia.org/wikipedia/commons/6/6e/Smartphone.jpg" },
    { name: "pizza", imageUrl: "https://upload.wikimedia.org/wikipedia/commons/7/7b/Pizza.jpg" },
  ]);
  ...
  return (
    ...
    <div className="min-h-screen bg-ci bg-custom-gradient text-white flex flex-col items-center justify-center pt-12">
      ...
      <div className="container max-w-4xl mx-auto px-6 py-4">
        <h1 className="text-4xl font-bold mb-2 text-center text-pink-400">🎤 Object Guessing Game</h1>
        ...
        {gameOver ? (
          ...
          <div className="text-center">
            <div className="grid grid-cols-3 gap-4 mb-3">
              <p className="bg-indigo-800 p-4 rounded-lg shadow">⏳ Time: <span className="text-blue-400">{time} sec</span></p>
              <p className="bg-indigo-800 p-4 rounded-lg shadow">⭐ Score: <span className="text-green-400">{score}</span></p>
              <p className="bg-indigo-800 p-4 rounded-lg shadow">❤️ Chances: <span className="text-red-400">{chances}</span></p>
            </div>
